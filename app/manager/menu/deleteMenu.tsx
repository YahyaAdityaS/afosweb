               ...
               <div className="sticky top-0 bg-sky-600 px-5 pt-5 pb-3 shadow">
                   <div className="w-full flex items-center">
                       <div className="flex flex-col">
                           <strong className="text-white font-bold text-2xl">Delete Menu</strong>
                           <small className="text-white text-sm">Menus with existing transaction data cannot be deleted from this page.</small>
                       </div>
